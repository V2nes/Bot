...
public class Bot extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "JavaSpecialSkill";
    }

    @Override
    public String getBotToken() {
        return "6349806336:AAHqrsHGEhRGN6OVyavlLzztyVeZemNppZc";
    }
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (text.equals("/start")) {
            ...
            sendText(userId, "Тест окончен. Для перезапуска бота используйте команду /start");
        } else {
